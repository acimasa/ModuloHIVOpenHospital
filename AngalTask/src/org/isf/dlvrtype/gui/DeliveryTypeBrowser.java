...
public class DeliveryTypeBrowser extends ModalJFrame implements DeliveryTypeListener{
	...
	private JButton getJNewButton() {
		if (jNewButton == null) {
			...
			jNewButton.setText(MessageBundle.getMessage("angal.dlvrtype.new"));
	...
	private JButton getJEditButton() {
		if (jEditButton == null) {
			...
			jEditButton.setText(MessageBundle.getMessage("angal.dlvrtype.edit"));
				...
				public void actionPerformed(ActionEvent event) {
					if (jTable.getSelectedRow() < 0) {
						JOptionPane.showMessageDialog(null,
								MessageBundle.getMessage("angal.dlvrtype.pleaseselectarow"), MessageBundle.getMessage("angal.hospital"),
	...
	private JButton getJCloseButton() {
		if (jCloseButton == null) {
			...
			jCloseButton.setText(MessageBundle.getMessage("angal.dlvrtype.close"));
	...
	private JButton getJDeteleButton() {
		if (jDeteleButton == null) {
			...
			jDeteleButton.setText(MessageBundle.getMessage("angal.dlvrtype.delete"));
