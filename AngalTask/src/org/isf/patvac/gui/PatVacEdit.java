...
public class PatVacEdit extends JDialog {
	...
	private JPanel getDataPanel() {
		if (dataPanel == null) {
			...
			// vaccine date
			vaccineDateLabel = new JLabel(MessageBundle.getMessage("angal.patvac.date"));
	...
	private JButton getOkButton() {
		if (okButton == null) {
			...
			okButton.setText(MessageBundle.getMessage("angal.patvac.ok"));
	...
	private JButton getCancelButton() {
		if (cancelButton == null) {
			...
			cancelButton.setText(MessageBundle.getMessage("angal.patvac.cancel"));
