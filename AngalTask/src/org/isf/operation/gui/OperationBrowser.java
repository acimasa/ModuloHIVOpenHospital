...
public class OperationBrowser extends ModalJFrame implements OperationEdit.OperationListener {
	...
	public OperationBrowser() {
		...
		JButton buttonNew = new JButton(MessageBundle.getMessage("angal.operation.new"));
		...
		JButton buttonEdit = new JButton(MessageBundle.getMessage("angal.operation.edit"));
			...
			public void actionPerformed(ActionEvent event) {
				if (table.getSelectedRow() < 0) {
					JOptionPane.showMessageDialog(				
							null,
							MessageBundle.getMessage("angal.operation.pleaseselectarow"),
		...
		JButton buttonDelete = new JButton(MessageBundle.getMessage("angal.operation.delete"));
		...
		JButton buttonClose = new JButton(MessageBundle.getMessage("angal.operation.close"));
