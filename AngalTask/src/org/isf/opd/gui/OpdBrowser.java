...
//	private int pfrmWidth;
	...
	private int[] pColumwidth = { 30, 40, 25, 25, 195, 195, 50 };
	private boolean[] columnsVisible = { true, GeneralData.OPDEXTENDED, true, true, true, true, true };
	...
	private JButton getJDeteleButton() {
		if (jDeteleButton == null) {
			...
			jDeteleButton.setText(MessageBundle.getMessage("angal.opd.delete"));
