...
public class DeliveryResultTypeBrowserEdit extends JDialog{
	...
	private JButton getCancelButton() {
		if (cancelButton == null) {
			...
			cancelButton.setText(MessageBundle.getMessage("angal.dlvrrestype.cancel"));  // Generated
	...
	private JButton getOkButton() {
		if (okButton == null) {
			...
			okButton.setText(MessageBundle.getMessage("angal.dlvrrestype.ok"));  // Generated
