...
public class AdmissionTypeBrowser extends ModalJFrame implements LaboratoryTypeListener{
	...
	private JButton getJNewButton() {
		if (jNewButton == null) {
			...
			jNewButton.setText(MessageBundle.getMessage("angal.admtype.new"));
	...
	private JButton getJEditButton() {
		if (jEditButton == null) {
			...
			jEditButton.setText(MessageBundle.getMessage("angal.admtype.edit"));
				...
				public void actionPerformed(ActionEvent event) {
					if (jTable.getSelectedRow() < 0) {
						JOptionPane.showMessageDialog(null,
								MessageBundle.getMessage("angal.admtype.pleaseselectarow"), MessageBundle.getMessage("angal.hospital"),
	...
	private JButton getJCloseButton() {
		if (jCloseButton == null) {
			...
			jCloseButton.setText(MessageBundle.getMessage("angal.admtype.close"));
	...
	private JButton getJDeteleButton() {
		if (jDeteleButton == null) {
			...
			jDeteleButton.setText(MessageBundle.getMessage("angal.admtype.delete"));
