...
public class DiseaseBrowserManager {
	...
	public ArrayList<Disease> getDiseaseOpd() {
		try {
			return ioOperations.getDiseaseOpd();
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		}
	...
	/**
	 * Returns all the stored diseases.
	 * In case of error a message error is shown and a <code>null</code> value is returned.
	 * @return the stored diseases.
	 */
	...
	public ArrayList<Disease> getDiseaseOpd(String typecode) {
		try {
			return ioOperations.getDiseaseOpd(typecode);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		}
	...
	/**
	 * Returns all the stored {@link Disease} with IPD flag <code>true</code>.
	 * In case of error a message error is shown and a <code>null</code> value is returned.
	 * @return the stored disease with IPD flag <code>true</code>.
	 */
	public ArrayList<Disease> getDiseaseIpd() {
		try {
			return ioOperations.getDiseaseIpd();
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		}
	...
	/**
	 * Returns all the stored {@link Disease} with the specified typecode and the flag IPD <code>true</code>.
	 * In case of error a message error is shown and a <code>null</code> value is returned.
	 * @param typecode the filter typecode.
	 * @return the retrieved diseases.
	 */
	public ArrayList<Disease> getDiseaseIpd(String typecode) {
		try {
			return ioOperations.getDiseaseIpd(typecode);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		}
	...
	/**
	 * Retrieves all the stored {@link Disease} with the specified typecode.
	 * In case of error a message error is shown and a <code>null</code> value is returned.
	 * @param typecode the filter typecode.
	...
	public ArrayList<Disease> getDisease(String typecode) {
		try {
			return ioOperations.getDisease(typecode);
		} catch (OHException e) {
			JOptionPane.showMessageDialog(null, e.getMessage());
			return null;
		}
