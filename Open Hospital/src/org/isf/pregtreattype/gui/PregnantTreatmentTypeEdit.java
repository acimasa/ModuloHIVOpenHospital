...
public class PregnantTreatmentTypeEdit extends JDialog{
	...
	private JButton getCancelButton() {
		if (cancelButton == null) {
			...
			cancelButton.setText(MessageBundle.getMessage("angal.preagtreattype.cancel"));  // Generated
	...
	private JButton getOkButton() {
		if (okButton == null) {
			...
			okButton.setText(MessageBundle.getMessage("angal.preagtreattype.ok"));  // Generated
