...
public class VaccineTypeBrowser extends ModalJFrame implements VaccineTypeListener {
	...
	private JButton getJNewButton() {
		if (jNewButton == null) {
			...
			jNewButton.setText(MessageBundle.getMessage("angal.vactype.new"));
	...
	private JButton getJEditButton() {
		if (jEditButton == null) {
			...
			jEditButton.setText(MessageBundle.getMessage("angal.vactype.edit"));
				...
				public void actionPerformed(ActionEvent event) {
					if (jTable.getSelectedRow() < 0) {
						JOptionPane.showMessageDialog(null,
								MessageBundle.getMessage("angal.vactype.pleaseselectarow"), MessageBundle.getMessage("angal.hospital"),
	...
	private JButton getJCloseButton() {
		if (jCloseButton == null) {
			...
			jCloseButton.setText(MessageBundle.getMessage("angal.vactype.close"));
	...
	private JButton getJDeteleButton() {
		if (jDeteleButton == null) {
			...
			jDeteleButton.setText(MessageBundle.getMessage("angal.vactype.delete"));
