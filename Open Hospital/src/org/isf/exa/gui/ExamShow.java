...
public class ExamShow extends JDialog {
	...
	private JButton getNewButton(){
		if(newButton == null){
			...
			newButton.setText(MessageBundle.getMessage("angal.exa.new"));  // Generated
	...
	private JButton getCloseButton() {
		if (closeButton == null) {
			...
			closeButton.setText(MessageBundle.getMessage("angal.exa.close"));  // Generated
	...
	private JButton getDeleteButton() {
		if (deleteButton == null) {
			...
			deleteButton.setText(MessageBundle.getMessage("angal.exa.delete"));  // Generated
