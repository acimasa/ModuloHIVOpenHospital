...
public class ExamBrowser extends ModalJFrame{
	...
	public ExamBrowser() {
		...
		JButton buttonNew = new JButton(MessageBundle.getMessage("angal.exa.new"));
		...
		JButton buttonEdit = new JButton(MessageBundle.getMessage("angal.exa.edit"));
			...
			public void actionPerformed(ActionEvent event) {
				if (table.getSelectedRow() < 0) {
					JOptionPane.showMessageDialog(				
	                        null,
	                        MessageBundle.getMessage("angal.exa.pleaseselectarow"),
		...
		JButton buttonDelete = new JButton(MessageBundle.getMessage("angal.exa.delete"));
		...
		JButton buttonClose = new JButton(MessageBundle.getMessage("angal.exa.close"));
