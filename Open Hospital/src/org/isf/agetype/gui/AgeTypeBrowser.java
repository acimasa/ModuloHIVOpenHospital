...
public class AgeTypeBrowser extends ModalJFrame {
	...
	private JButton getJEditSaveButton() {
		if (jEditSaveButton == null) {
			...
			jEditSaveButton.setText(MessageBundle.getMessage("angal.agetype.edit"));
			...
			jEditSaveButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent event) {
					if (!edit) {
						edit = true;
						jEditSaveButton.setText(MessageBundle.getMessage("angal.agetype.save"));
	...
	private JButton getJCloseButton() {
		if (jCloseButton == null) {
			...
			jCloseButton.setText(MessageBundle.getMessage("angal.agetype.close"));
