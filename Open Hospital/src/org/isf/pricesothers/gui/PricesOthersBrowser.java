...
public class PricesOthersBrowser extends ModalJFrame implements PricesOthersListener {
	...
	private JButton getJButtonClose() {
		if (jButtonClose == null) {
			...
			jButtonClose.setText(MessageBundle.getMessage("angal.pricesothers.close")); //$NON-NLS-1$
	...
	private JButton getJButtonDelete() {
		if (jButtonDelete == null) {
			...
			jButtonDelete.setText(MessageBundle.getMessage("angal.pricesothers.delete")); //$NON-NLS-1$
	...
	private JButton getJButtonEdit() {
		if (jButtonEdit == null) {
			...
			jButtonEdit.setText(MessageBundle.getMessage("angal.pricesothers.edit")); //$NON-NLS-1$
	...
	private JButton getJButtonNew() {
		if (jButtonNew == null) {
			...
			jButtonNew.setText(MessageBundle.getMessage("angal.pricesothers.new")); //$NON-NLS-1$
