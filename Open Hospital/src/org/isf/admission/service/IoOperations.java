...
public class IoOperations {
	...
	protected Admission toAdmission(ResultSet resultSet) throws SQLException
	{
		...
		admission.setAdmDate(toCalendar(resultSet.getDate("ADM_DATE_ADM")));
		...
		admission.setOpDate(toCalendar(resultSet.getDate("ADM_DATE_OP")));
		admission.setDisDate(toCalendar(resultSet.getDate("ADM_DATE_DIS")));
		...
		admission.setVisitDate(toCalendar(resultSet.getDate("ADM_PRG_DATE_VIS")));
		admission.setPregTreatmentType(resultSet.getString("ADM_PRG_PTT_ID_A"));
		admission.setDeliveryDate(toCalendar(resultSet.getDate("ADM_PRG_DATE_DEL")));
		...
		admission.setCtrlDate1(toCalendar(resultSet.getDate("ADM_PRG_DATE_CTRL1")));
		admission.setCtrlDate2(toCalendar(resultSet.getDate("ADM_PRG_DATE_CTRL2")));
		admission.setAbortDate(toCalendar(resultSet.getDate("ADM_PRG_DATE_ABORT")));
	...
	protected List<Object> getInsertParameters(Admission admission)
	{
		...
		parameters.add(toDate(admission.getAdmDate()));
