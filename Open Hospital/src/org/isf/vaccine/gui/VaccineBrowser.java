...
//		myFrame = this;
	...
	private JButton getJEditButton() {
		if (jEditButton == null) {
			...
			jEditButton.setText(MessageBundle.getMessage("angal.vaccine.edit"));
				...
				public void actionPerformed(ActionEvent event) {
					if (table.getSelectedRow() < 0) {
						JOptionPane.showMessageDialog(
								null,
								MessageBundle.getMessage("angal.vaccine.pleaseselectarow"),
								MessageBundle.getMessage("angal.vaccine.stlukehospital"),
	...
	private JButton getJNewButton() {
		if (jNewButton == null) {
			...
			jNewButton.setText(MessageBundle.getMessage("angal.vaccine.new"));
	...
	private JButton getJDeleteButton() {
		if (jDeleteButton == null) {
			...
			jDeleteButton.setText(MessageBundle.getMessage("angal.vaccine.delete"));
	...
	private JButton getJCloseButton() {
		if (jCloseButton == null) {
			...
			jCloseButton.setText(MessageBundle.getMessage("angal.vaccine.close"));
