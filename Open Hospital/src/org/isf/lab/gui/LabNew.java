...
//---------------------------------------------------------------------------
	...
	private JButton getJButtonCancel() {
		if (jButtonCancel == null) {
			...
			jButtonCancel.setText(MessageBundle.getMessage("angal.labnew.cancel"));
	...
	private JButton getJButtonOK() {
		if (jButtonOK == null) {
			...
			jButtonOK.setText(MessageBundle.getMessage("angal.labnew.ok"));
	...
	private JDateChooser getJCalendarDate() {
		if (jCalendarDate == null) {
			jCalendarDate = new JDateChooser(RememberDates.getLastLabExamDate()); //To remind last used
